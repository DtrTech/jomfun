	...
	<nav id="main-nav" data-skin="search-in-main-nav" class="main-nav header-nav live-search-parent" style="line-height:120px" aria-label="Primary Navigation">
		...
		<div id="logo" class="image-logo" >
			<a title="JomFun" href="https://klfoodie.com/">
				...
				<picture class="tie-logo-default tie-logo-picture">
					...
					<img class="tie-logo-img-default tie-logo-img" src="https://cdn.klfoodie.com/2023/01/kl-foodie-1.png" alt="JomFun" width="350" height="80" style="max-height:80px; width: auto;" />
				</picture>
			<h1 class="h1-off">JomFun</h1>			</a>
		</div>
								</div>
		...
		<div id="sticky-logo" class="image-logo">
			...
			<a title="JomFun" href="https://klfoodie.com/">
				...
				<picture class="tie-logo-default tie-logo-picture">
					<source class="tie-logo-source-default tie-logo-source" srcset="https://cdn.klfoodie.com/2023/01/kl-foodie-1.png">
					<img class="tie-logo-img-default tie-logo-img" src="https://cdn.klfoodie.com/2023/01/kl-foodie-1.png" alt="JomFun"  />
				</picture>
						</a>
		</div>
